...
namespace ERP.Logistica.Models
{
    public class MedicamentosTeste
    {
        ...
        public static void adicionarQuantidade(int lote, int quantidade)
        {
            int quantMed = 0;
            quantMed = MedicamentosTeste.obterQuantidade(lote);
            MedicamentosTeste.alterarQuantidade(lote, quantMed + quantidade);
        }

        public static bool removerQuantidade(int lote, int quantidade)
        {
            int quantMed = 0;
            quantMed = MedicamentosTeste.obterQuantidade(lote);
        ...
        private static int obterQuantidade(int lote)
        {
            try
            {
        ...
        private static void alterarQuantidade(int lote, int quantidade)
        {
            try
            {
                SqlConnection connection = new SqlConnection(connectionSettings);
