    ...
    public partial class GerenciaLotesQuantidades : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!((Page)System.Web.HttpContext.Current.CurrentHandler).IsPostBack)
            {
                ...
                ddlConsulta.DataSource = ConsultasController.listar();
        ...
        protected void btnOk_Click(object sender, EventArgs e)
        {
            ...
            switch (aux)
            {
                case 0:
                    ...
                    HistoricoEstoqueController.criar(ddlConsulta.SelectedValue.ToString(), DateTime.Now, Convert.ToInt32(tbAdicao.Text), estoque.Medicamento.Id);
                    return;
                case 1:
